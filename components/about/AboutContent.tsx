        ...
        <div className="container-custom py-20 space-y-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    {/* Floating Stats */}
                    <div className="absolute -bottom-6 -right-6 bg-black/90 p-6 rounded-2xl shadow-2xl border-2 border-cyan-400/30 backdrop-blur-xl">
                        <div className="space-y-2">
                            <div className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400 drop-shadow-[0_0_10px_rgba(34,211,238,0.5)]">{content.experienceYears || "11+"}</div>
                            <div className="text-sm text-white font-semibold tracking-wide">Years Experience</div>
                        </div>
                    </div>
                </motion.div>
            </div>
