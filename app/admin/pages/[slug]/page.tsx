...
export default function PageEditor() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        } catch (error: any) { // Added : any to error for type safety
            console.error("Error updating content:", error);
            toast({
                title: "Error",
                description: error.message || "Failed to update page content.", // Use error.message
                variant: "destructive",
            });
        } finally {
            setIsSaving(false);
                            ...
                            {slug === 'about' && (
                                <>
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-sm font-medium">Subtitle 1</label>
                                            <Textarea
